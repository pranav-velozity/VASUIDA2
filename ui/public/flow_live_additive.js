    ...
    const receivingView = () => {
      ...
      return `
        ...
        <div class="mt-3 space-y-3">
          ...
          <button onclick="window.show('#receiving')" style="width:100%;display:flex;align-items:center;justify-content:center;gap:8px;background:#1C1C1E;color:#fff;border:none;border-radius:10px;padding:11px 16px;font-size:12px;font-weight:500;cursor:pointer;font-family:inherit;" onmouseover="this.style.opacity='.85'" onmouseout="this.style.opacity='1'">
